...
public class KpointController {
    ...
    /**
     * 艹！这个接口查询章节下所有知识点的详细掌握情况
     * 包括掌握率、能力值、测评统计、得分等所有数据，一次性给你搞定！
     */
    @GetMapping("/masteryList")
    ...
    public R<List<KpointMasteryVO>> getKpointMasteryList(
            @ApiParam(value = "章节ID", required = true) @RequestParam(value = "chapterId") Long chapterId,
